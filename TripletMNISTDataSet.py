...
#Train: For each sample (anchor) randomly chooses a positive and negative samples
    ...
    def __init__(self, mnist_dataset):
        ...
        if self.train:
            ...
            triplets = [[i,random_state.choice(self.label_to_indices[self.test_labels[i].item()]),random_state.choice(self.label_to_indices[np.random.choice(list(self.labels_set -set([self.test_labels[i].item()])))])]for i in range(len(self.test_data))]
